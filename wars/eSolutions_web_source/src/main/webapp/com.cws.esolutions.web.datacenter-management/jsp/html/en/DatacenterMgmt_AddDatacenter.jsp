...
<div id="homecontent">
    <div class="wrapper">
		...
		<form:form id="createNewDatacenter" name="createNewDatacenter" action="${pageContext.request.contextPath}/ui/datacenter-management/add-datacenter" method="post">
		    ...
		    <input type="button" name="cancel" value="<spring:message code='theme.button.cancel.text' />" id="cancel" class="submit" onclick="redirectOnCancel('${pageContext.request.contextPath}/ui/datacenter-management/default');" />
		</form:form>
    </div>
</div>
