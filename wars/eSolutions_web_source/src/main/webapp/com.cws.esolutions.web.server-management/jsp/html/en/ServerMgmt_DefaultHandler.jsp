        ...
        <c:if test="${not empty searchResults}">
            ...
            <table id="searchResults">
                <c:forEach var="result" items="${searchResults}">
                    <tr>
                        <td><a href="<c:url value='${pageContext.request.contextPath}/ui/server-management/server/${result.serverGuid}' />" title="${result.operHostName}">${result.operHostName}</a></td>
                    </tr>
                </c:forEach>
            </table>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${pages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td><a href="<c:url value='${pageContext.request.contextPath}/server-management/search/terms/${searchTerms}/page/${i}' />" title="${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
