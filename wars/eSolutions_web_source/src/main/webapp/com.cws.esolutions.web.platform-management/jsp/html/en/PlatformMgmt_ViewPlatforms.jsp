        ...
        <p>
            <table id="viewPlatformList">
                ...
                <c:forEach var="platform" items="${platformList}">
                    <tr>
                        <td><a href="${pageContext.request.contextPath}/ui/platform-management/platform/view/${platform.platformGuid}" title="${platform.platformName}">${platform.platformName}</a></td>
                    </tr>
                </c:forEach>
            </table>
        </p>
