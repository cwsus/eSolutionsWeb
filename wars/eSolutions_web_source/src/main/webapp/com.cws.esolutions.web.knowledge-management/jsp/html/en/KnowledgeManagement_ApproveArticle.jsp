        ...
        <c:choose>
            <c:when test="${not empty articleData}">
                <form:form id="approveArticle" name="approveArticle" action="${pageContext.request.contextPath}/ui/knowledge-management/approve-article" method="post">
		            ...
		            <input type="button" name="execute" value="<spring:message code='knowledgebase.approve.article' />" id="execute" class="submit" onclick="disableButton(this); validateForm(this.form);" />
		            <input type="button" name="reset" value="<spring:message code='theme.button.reset.text' />" id="reset" class="submit" onclick="clearForm();" />
		            <input type="button" name="cancel" value="<spring:message code='theme.button.cancel.text' />" id="cancel" class="submit" onclick="redirectOnCancel('${pageContext.request.contextPath}/ui/knowledge-management/list-pending');" />
                </form:form>
            </c:when>
            <c:otherwise>
