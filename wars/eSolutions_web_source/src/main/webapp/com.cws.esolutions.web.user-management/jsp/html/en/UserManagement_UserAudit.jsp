    ...
    <div class="wrapper">
        <div id="content">
            ...
            <ul>
                ...
                <li><a href="<c:url value='/ui/user-management/view/account/${foundAccount.guid}' />" title="<spring:message code='theme.previous.page' />"><spring:message code='theme.previous.page' /></a></li>
            </ul>
        </div>
        <br class="clear" />
    </div>
