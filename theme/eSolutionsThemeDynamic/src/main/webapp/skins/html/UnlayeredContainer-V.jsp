...
<c:set var="layoutNodeId" value="${wp.identification[requestScope['currentLayoutNode']]}" scope="page"/>

<table class="layoutColumn ibmDndColumn component-container ${not empty pageScope.layoutNodeId ? 'id-' : ''}${pageScope.layoutNodeId}${not empty pageScope.layoutNodeId ? ' layoutNode' : ''}" cellpadding="0" cellspacing="0" role="presentation">
