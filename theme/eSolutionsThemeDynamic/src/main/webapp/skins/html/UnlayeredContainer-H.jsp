...
<table class="layoutRow ibmDndRow component-container ${not empty pageScope.layoutNodeId ? 'id-' : ''}${pageScope.layoutNodeId}${not empty pageScope.layoutNodeId ? ' layoutNode' : ''}" cellpadding="0" cellspacing="0" role="presentation">
	<tr>
<%
